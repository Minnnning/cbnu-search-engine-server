...
if __name__ == '__main__':
    ...
    scheduler.add_job(run_electronics_information_school, 'cron', hour=18, minute=5, id='electronics_information_school')

    # DB -> ES 동기화 작업
    scheduler.add_job(sync_db_to_es, 'cron', hour=17, minute=45, id='sync_db_to_es')
